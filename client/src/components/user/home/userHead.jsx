                ...
                <div className="md:grid grid-cols-3 container py-10 ">
                    ...
                    <div className="bg-green p-3 rounded text-gray-600 col-span-2 pl-10">
                        <div className="flex items-center">
                            ...
                            {/* <button type='button'
                                className='flex break-inside bg-black rounded-3xl px-8 py-4 mb-4 dark:bg-slate-800 dark:text-white w-10 h-10'>
                ...
                {post ?
                    data.length > 0 ?
                        data.map((data) => {
                         ...
                         <div className="text-5xl uppercase text-center mx-auto">Nothing to Show</div>
                    ...
                    data.length > 0 ?
                        ...
                        <div className="grid grid-cols-3 grid-rows-3 place-items-center h-screen">
                            <div className="col-start-2 row-start-2 ">
                                <div className="text-5xl uppercase text-center"> Nothing to Show</div>
                            </div>
                        </div>
                }
                </div>
